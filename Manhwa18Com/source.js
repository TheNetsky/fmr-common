...
class FlatMangaReader extends paperback_extensions_common_1.Source {
    constructor() {
         ...
         */
        this.sourceTraversalPathName = ""; //ADD A "/" AT THE END!
        this.sourceMangaDirectory = this.sourceTraversalPathName;
        /**
        ...
        */
        ...
        this.mangaIconDomain = "";
        //CHAPTER SELECTORS
        /**
         * a
         */
        this.chapterQuerySelector = "div#tab-chapper";
        this.chapterItemSelector = 'tr';
        this.chapterUrlSelector = "a";
        this.chapterTimeSelector = "time";
        this.chapterNameSelector = "b";
        //CHAPTER DETAILS SELECTORS
        this.pageListImageSelector = "img.chapter-img";
        /**
        ...
        */
        ...
        this.parser = new FlatMangaReaderParser_1.Parser();
    }
...
},{"./FlatMangaReaderParser":35,"paperback-extensions-common":12}],35:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    constructor() {
        ...
        this.parseViewMore = ($, homepageSectionId, source) => {
            var _a, _b, _c, _d;
            const manga = [];
            const collectedIds = [];
            for (const obj of $("div.bs", "div.listupd").toArray()) {
                ...
                const image = (_d = (_c = this.getImageSrc($("img", obj))) === null || _c === void 0 ? void 0 : _c.split("?resize")[0]) !== null && _d !== void 0 ? _d : "";
    ...
    parseMangaDetails($, mangaId, source) {
        ...
        */
        ...
        const rawStatus = (_a = $("li a.btn-success").first()) === null || _a === void 0 ? void 0 : _a.text().replace(/ /g, "");
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const chapter of $(source.chapterItemSelector, source.chapterQuerySelector).toArray().reverse()) {
            const id = (_b = (_a = $(source.chapterUrlSelector, chapter).attr('href')) === null || _a === void 0 ? void 0 : _a.replace(".html", "")) !== null && _b !== void 0 ? _b : "";
    ...
    parseHomeSections($, sections, sectionCallback, source) {
        ...
        for (const manga of $("div.item", "div.owl-carousel").toArray()) {
            const id = (_b = (_a = $("a", manga).attr('href')) === null || _a === void 0 ? void 0 : _a.replace(".html", "")) !== null && _b !== void 0 ? _b : "";
            let image = (_c = this.getImageSrc($("img", manga))) === null || _c === void 0 ? void 0 : _c.split("?")[0];
            if (!image.startsWith("http") && source.mangaIconDomain)
                image = (source.mangaIconDomain + image);
...
},{"entities":5,"paperback-extensions-common":12}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Manhwa18Com = exports.Manhwa18ComInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const FlatMangaReader_1 = require("../FlatMangaReader");
const MANHWA18_DOMAIN = "https://manhwa18.com";
exports.Manhwa18ComInfo = {
    version: '1.0.0',
    name: 'manhwa18.com',
...
class Manhwa18Com extends FlatMangaReader_1.FlatMangaReader {
    constructor() {
        super(...arguments);
        this.baseUrl = MANHWA18_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.ENGLISH;
        this.fileExtention = ".html";
        this.hasAdvancedSearchPage = true;
        //----Manga Details Selectors
        this.mangaIconDomain = MANHWA18_DOMAIN;
        //----Chapters Selectors
        //chapterNameSelector: string = ""
        //chapterTimeSelector: string = ""
    }
}
exports.Manhwa18Com = Manhwa18Com;

},{"../FlatMangaReader":34,"paperback-extensions-common":12}]},{},[36])(36)
});
