...
import { Manhwa18Net } from '../Manhwa18Net/Manhwa18Net'
import { APIWrapper } from "paperback-extensions-common";

describe('Manhwa18Net Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: FlatMangaReader = new Manhwa18Net(cheerio);
    ...
    it("Testing home page results for new manga titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "new_manga", {},);
    ...
    it("Testing home page results for top all time manga titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "top_alltime", {},);
    ...
    it("Testing home page results for top monthly titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "top_monthly", {},);
    ...
    it("Testing home page results for top weekly titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "top_weekly", {},);
    ...
    it("Testing Home-Page aquisition", async () => {
        ...
        expect(homePages[1], "No lnew manga section available").to.exist
        expect(homePages[2], "No top all time section available").to.exist
        expect(homePages[3], "No top all today section available").to.exist
    });
    ...
    it("Testing Notifications", async () => {
        let updates = await wrapper.filterUpdatedManga(source, new Date("2021-5-10"), [mangaId]);
